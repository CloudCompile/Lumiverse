...
export const BUILT_IN_DRAWER_TABS: readonly SpindleUIDrawerTabEntry[] = [
  ...
  { id: "status", shortName: "Status", tabName: "Status", tabDescription: "Check connection health and open provider status pages", keywords: ["status", "health", "uptime", "outage", "provider", "model", "monitor", "connection"] },
